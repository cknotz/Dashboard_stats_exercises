---
title: "Tutorial 1: Installation & First Steps"
author: "*Kvantitativ forskningsmetode*"
date: "(BST 290)"
output: 
  pdf_document:
...
To successfully complete the *Kvantitativ forskningsmetode* course, you need to show that you can conduct statistical analyses on your own using `R` and `RStudio`. This first tutorial introduces you to the two applications, helps you install them on your computer, and guides you through some "warm-up" exercises to familiarize yourself with the `R` environment.
