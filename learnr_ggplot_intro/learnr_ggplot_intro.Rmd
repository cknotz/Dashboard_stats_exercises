...
So far, the main dimensions or aesthetics of our graphs that we have defined are the two axes. We have placed one variable on the x-axis and one on the y-axis. But sometimes we want to add a third variable to show some some more complicated relationships. One way of doing this is to change the sizes of the points according to the values of another variable. 
