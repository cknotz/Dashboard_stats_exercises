...
The first thing we need is some data that we can graph. We start _very_ simple and use a tiny practice-dataset that is easy to handle. I've created this for you --- here is how it looks like:
